...
{
	private static final String[] Number = { "Apple", "Asparagus", "Avocado", "Bambooshoot", "Banana", "Barley", "Blackberry", "Cactusfruit", "Cantaloupe", "Cauliflower", "Cherry", "Cinnamon", "Coconut", "Corn", "Cotton", "Cranberry", "Dragonfruit", "Grape", "Kiwi", "Lemon", "Lime", "Mango", "Nutmeg", "Olive", "Orange", "Papaya", "Peach", "Pear", "Plum", "Peppercorn", "Pomegranate", "Raspberry", "Rutabaga", "Rhubarb", "Lettuce", "Brusselsprout", "Maloberry", "Rye", "Rice", "Vanillabean", "Mushroom", "Citron", "BuddhaHand", "Blueberry", "Chestnut", "Date", "Kumquat", "Blackthorn", "Almond", "Apricot", "Grapefruit", "Pomelo", "SandPear", "Hazelnut", "Beechnut", "Pecan", "Plantain", "BrazilNut", "Fig", "Acorn", "Elderberry", "GinkoNut", "Coffee", "OsangeOrange", "Clove", "Artichoke", "Bambooshoot", "Bean", "Beet", "Bellpepper", "Broccoli", "Cabbage", "Candle", "Canteloupe", "Celery", "Chilipepper", "Cucumber", "Edibleroot", "Eggplant", "Garlic", "Ginger", "Leek", "Mustard", "Oats", "Okra", "Onion", "Parsnip", "Peanut", "Peas", "Pineapple", "Radish", "Scallion", "Seaweed", "Soybean", "Spiceleaf", "Starfruit", "Strawberry", "Sunflower", "Sweetpotato", "Tea", "Tomato", "Turnip", "Walnut", "Whitemushroom", "Wintersquash", "Zucchini" };
